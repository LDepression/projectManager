...
import (
	...
	"projectManager/project-api/pkg/model/tasks"
	common "projectManager/project-common"
	"projectManager/project-common/errs"
	"projectManager/project-common/fs"
...
func (t *HandlerTask) saveTask(c *gin.Context) {
	...
	defer cancel()
	msg := &task.TaskReqMessage{
		ProjectCode: req.ProjectCode,        //项目id
		Name:        req.Name,               //任务的名称
		StageCode:   req.StageCode,          //流程的编号
		AssignTo:    req.AssignTo,           //分配人
		MemberId:    c.GetInt64("memberId"), //创建人
	}
